...
const mockRecentLeads: Lead[] = [
    { id: '1', name: 'Alice Johnson', email: 'alice@example.com', phone: '(555) 123-4567', source: 'Organic Search', status: 'Qualified', delivery_status: 'Delivered', created_at: '2024-05-07', street: '123 Main St', city: 'New York', state: 'New York', zip_code: '10001', notes: [] },
    { id: '2', name: 'Bob Williams', email: 'bob@example.com', phone: '(555) 987-6543', source: 'Facebook Ads', status: 'Not Qualified', delivery_status: 'Pending', created_at: '2024-05-07', street: '456 Oak Ave', city: 'Los Angeles', state: 'California', zip_code: '90001', notes: [] },
    { id: '3', name: 'Charlie Brown', email: 'charlie@example.com', phone: '(555) 234-5678', source: 'Referral', status: 'Not Qualified', delivery_status: 'Failed', created_at: '2024-05-06', street: '789 Pine Ln', city: 'Chicago', state: 'Illinois', zip_code: '60601', notes: [] },
];
    ...
    const { totalNeeded, qualifiedNeeded, notQualifiedNeeded } = useMemo(() => {
        ...
        activeBuyers.forEach(buyer => {
            ...
            if (remainingCap > 0) {
                ...
                if (['Qualified', 'Both'].includes(buyer.lead_qualification_preference)) {
                    qualified += remainingCap;
                }
                if (['Not Qualified', 'Both'].includes(buyer.lead_qualification_preference)) {
